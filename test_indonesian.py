...
# ~30s of Indonesian text. 12.5 Hz frame rate => 375 frames ~ 30s
text_id = (
...
conversations = [
    [processor.build_user_message(text=text_id, language="Malay", tokens=375)],
]
...
for i, message in enumerate(processor.decode(outputs)):
    ...
    out_path = out_dir / "output_indonesian.wav"
